...
void Page_61_Ex_1(void)
{
    cout << "_____________"  << endl << "Page_61_Ex_1" << endl << "_____________" << endl;
...
void page_62_Ex_2 (void)
{
    cout << "_____________"  << endl << "page_62_Ex_2" << endl << "_____________" << endl;
    for (int line=1 ; line<=5 ; line++)
    {
...
void Page_63_Ex_3 (void)
{
    cout << "_____________"  << endl << "Page_63_Ex_3" << endl << "_____________" << endl;
    cout << "+" << " ";
    for (int i=1;i<=5;i++)
        cout << i << " ";
