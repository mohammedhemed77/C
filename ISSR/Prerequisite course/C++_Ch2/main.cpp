...
void Page_32_Ex_1 (void)
{
    cout << "_____________"  << endl << "Page_32_Ex_1" << endl << "_____________" << endl;
    int r , area , circum = 0;
    float Pi = 3.14159;
...
void Page_32_Ex_2 (void)
{
    cout << "_____________"  << endl << "Page_32_Ex_2" << endl << "_____________" << endl;
    float f , c = 0.0;
...
void Page_32_Ex_3 (void)
{
    cout << "_____________"  << endl << "Page_32_Ex_3" << endl << "_____________" << endl;
    float p , k = 0.0;
...
void Page_32_Ex_4 (void)
{
    cout << "_____________"  << endl << "Page_32_Ex_4" << endl << "_____________" << endl;
...
void Page_33_Ex_5 (void)
{
    cout << "_____________"  << endl << "Page_33_Ex_5" << endl << "_____________" << endl;
...
void Page_33_Ex_6 (void)
{
    cout << "_____________"  << endl << "Page_33_Ex_6" << endl << "_____________" << endl;
...
void Page_34_Ex_7 (void)
{
    cout << "_____________"  << endl << "Page_34_Ex_7" << endl << "_____________" << endl;
...
void Page_34_Ex_8 (void)
{
    cout << "_____________"  << endl << "Page_34_Ex_8" << endl << "_____________" << endl;
    float interest = .06;
